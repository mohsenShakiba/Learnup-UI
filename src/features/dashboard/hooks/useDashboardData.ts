...
import { LeitnerBoxService, LessonsService, PlacementService, SubscriptionsService, UsersService } from '../../../api/Learnup';
...
export function useDashboardData () {
  ...
  const placementResultQuery = useQuery({
  ...
  return {
    ...
    leitnerTotalItems,
    leitnerDueItems,
    placementLevel: placementResultQuery.data?.placedLevel,
